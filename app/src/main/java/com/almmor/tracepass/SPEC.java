...
public final class SPEC {
	...
	public enum PROP {
		...
		TRANS_AMOUNT(R.string.spec_prop_trans_amount),
		TRANS_TYPE(R.string.spec_prop_trans_type),
		TRANS_TIME(R.string.spec_prop_trans_time),
		TRANS_SIGN(R.string.spec_prop_trans_sign),
		TERMINAL_ID(R.string.spec_prop_terminal_id),
		CITY_NAME(R.string.spec_prop_city_name);
